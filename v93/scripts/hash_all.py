...
ap.add_argument('--out',default='codex/manifest.v93.json'); a=ap.parse_args()
...
m={"title":"Codex v93 — Integrity Manifest","subject_id_sha256":"2948fbc4ba1c0d7341204908882b89134a999f3e8f77f4a6a00ce6b68770282a","generated_utc":datetime.datetime.utcnow().isoformat()+"Z","items":items}
